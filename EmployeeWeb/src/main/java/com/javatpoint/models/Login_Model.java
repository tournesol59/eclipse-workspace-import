...
public class Login_Model {
   ...
   public String do_login_process(String username, String password) throws SQLException 
 {
      ...
      try {
         FileReader f=new FileReader("./eltechdb.properties");
	 ...
	 System.out.println("Buffered reader from proprties error");
      ...
      // pass them
      Database_Connectivity dc = new Database_Connectivity(dbusername, dbpassword); // recopy this class from the Udemy course
      dc.openConnection();
